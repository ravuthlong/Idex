...
public class Graph {
    ...
    private int c20;
    private int value;
    private int totalFillFloor;
    private int totalKillFloor;
    ...
    public void setTotalFillFloor(int totalFillFloor) {
        this.totalFillFloor = totalFillFloor;
    }

    public int getTotalFillFloor() {
        return this.totalFillFloor;
    }

    public void setTotalKillFloor(int totalKillFloor) {
        this.totalKillFloor = totalKillFloor;
    }

    public int getTotalKillFloor() {
        return this.totalKillFloor;
    }
